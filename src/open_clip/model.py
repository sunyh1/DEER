...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, normalize: bool = False, modality_ids: Optional[torch.Tensor] = None):
        features = self.visual(image, modality_ids)
    ...
    def forward(
        ...
        image_features = self.encode_image(image, normalize=True, modality_ids=modality_ids) if image is not None else None
